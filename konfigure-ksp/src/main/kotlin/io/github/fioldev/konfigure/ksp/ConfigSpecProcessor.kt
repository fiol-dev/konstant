...
class ConfigSpecProcessor(
    ...
    private fun generateCode(decl: KSClassDeclaration) {
        ...
        val code = buildString {
            ...
            appendLine()
            appendLine("import io.github.fioldev.konfigure.core.ConfigError")
            appendLine("import io.github.fioldev.konfigure.core.ConfigLoader")
            appendLine("import io.github.fioldev.konfigure.core.ConfigResult")
            appendLine("import io.github.fioldev.konfigure.core.FieldDescriptor")
            appendLine("import io.github.fioldev.konfigure.core.KeyUtils")
            appendLine("import io.github.fioldev.konfigure.core.ResolveResult")
            appendLine()
