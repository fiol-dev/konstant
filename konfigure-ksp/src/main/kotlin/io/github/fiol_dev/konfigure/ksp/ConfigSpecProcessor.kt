...
class ConfigSpecProcessor(
    ...
    private fun generateCode(decl: KSClassDeclaration) {
        ...
        val code = buildString {
            ...
            appendLine()
            appendLine("import io.github.fiol_dev.konfigure.core.ConfigError")
            appendLine("import io.github.fiol_dev.konfigure.core.ConfigLoader")
            appendLine("import io.github.fiol_dev.konfigure.core.ConfigResult")
            appendLine("import io.github.fiol_dev.konfigure.core.FieldDescriptor")
            appendLine("import io.github.fiol_dev.konfigure.core.KeyUtils")
            appendLine("import io.github.fiol_dev.konfigure.core.ResolveResult")
            appendLine()
